...
Linear Regression performed on House Pricing Dataset using [Nvidia Rapids](https://developer.nvidia.com/rapids) libraries such as CuPy, CuDF, CuML

#### [Kaggle Link of my completed and working Notebook](https://www.kaggle.com/gautammdiwan/linear-regresssion-using-rapids)
